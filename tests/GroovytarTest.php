...
final class GroovytarTest extends TestCase
{
    ...
    {
        $this->testGroovy = new class extends \AWonderPHP\Groovytar\Groovytar {
            /**
             * Predictable but different test salts.
             */
    ...
    public function testGetAvatarData(): void
    {
        ...
        $expected = array(
            ...
            'scheme' => null,
            'found_avatar' => true,
            'url' => 'https://devel.trippyid.com/avatar/6f7a27a19540c56af900cd8c98eed5b4?s=96&d=monsterid&r=g'
        );
        $actual = $this->testGroovy->getAvatarData($foo);
        //var_dump($actual);
        $this->assertEquals($expected, $actual);
        //$url2x = $groovytar->getAvatarUrl($id_or_email, array_merge($args, array( 'size' => $args['size'] * 2 )));
        $expected = 'https://devel.trippyid.com/avatar/6f7a27a19540c56af900cd8c98eed5b4?s=192&d=monsterid&r=g';
