...
class AdminMenu
{
    ...
    public static function domainMenu(): void
    {
        ...
        if ($j !== 0) {
            ...
            for ($i=0; $i<$j; $i++) {
                ...
                $label=\AWonderPHP\PluggableUnplugged\PunycodeStatic::unpunycodeDomain($domains[$i]);
                // @codingStandardsIgnoreLine
    ...
    public static function addressMenu(): void
    {
        ...
        if ($j !== 0) {
            ...
            for ($i=0; $i<$j; $i++) {
                ...
                $tmp=explode('@', $addys[$i]);
                $label=$tmp[0] . '@' . \AWonderPHP\PluggableUnplugged\PunycodeStatic::unpunycodeDomain($tmp[1]);
                // @codingStandardsIgnoreLine
    ...
    public static function userNotify(): void
    {
        ...
        \AWonderPHP\Groovytar\WordPressGroovytar::groovytarFooter();
        echo("\n");
        // @codingStandardsIgnoreLine
    ...
    {
        $groovytar = new \AWonderPHP\Groovytar\WordPressGroovytar();
